    ...
    {navLinks.map((link) => (
      <li className="md:mb-0 mb-1" key={link.href}>
        <a
          ...
          onClick={onClick}
          className="
            md:text-gray-300 md:hover:text-pink-400 md:active:text-pink-400 md:transition md:font-normal md:text-[14px]! md:tracking-wide md:py-0 md:px-0 md:rounded-none md:text-xs md:text-left
            ...
            hover:bg-neon-pink/10 hover:text-pink-400 active:bg-neon-pink/10 active:text-pink-400 md:hover:bg-transparent
          "
        >
          {link.label}
        </a>
